...
@Component
public class DoSapTransformProcAgainJob extends QuartzJobBean {

    private static final Logger logger = LoggerFactory.getLogger(DoSapTransformProcAgainJob.class);
